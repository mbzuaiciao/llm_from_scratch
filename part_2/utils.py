...
def top_k_top_p_filtering(logits: torch.Tensor, top_k: int | None = None, top_p: float | None = None):
    ...
    # --- Top-k filtering ---
    # If top_k is specified, keep only the k most likely tokens.
    if top_k is not None and top_k < V:
        ...
        # Set all logits lower than the threshold to -infinity. They will have a probability of 0 after softmax.
